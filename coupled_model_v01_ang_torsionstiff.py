...
inputfolder = 'examples/input_iea15mw_ang_torsionstiff_50'
projectfolder = 'examples/project_folder_ang_torsionstiff_50'
...
bevc.from_htc_file(os.path.join(inputfolder, 'IEA_15MW_RWT_ae_nsec_50_tors_stiff.htc'),model_path='./')
