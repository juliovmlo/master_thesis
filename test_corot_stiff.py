"""
Model with the structural solver and inertial loads.
Using the stiff blade.
"""
...
from utils import save_load, get_cg_offset
...
# Input files folder
inputfolder = 'examples/project_folder_ang_torsionstiff/stru'
