...
inputfolder = 'examples/input_iea15mw_ang'
projectfolder = 'examples/project_folder_ang'
...
bevc.from_htc_file('examples/input_iea15mw_ang/IEA_15MW_RWT_Onshore_steadystate.htc',model_path='./')
...
aero_force_hist = np.zeros((beam.numNode,6,0))
tip_def_history = []
delta_history = []
iter = 0
