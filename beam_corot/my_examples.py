...
# Load models
from TimoBeam import TimoBeam 
from TimoBeamV2 import TimoBeamV2
from ComplBeam import ComplBeam
from CoRot import CoRot # I'm going to use this model
...
model_folder = r"beam_corot\examples\twisted_beam"
